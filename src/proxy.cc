...
DEFINE_int32(fragments, 0, "#fragments generated with erasure code. " \
    "0 means not using erasure coding; -1 means using XOR coding.");
...
//  FLAGS_log_dir = "./logp";
  ...
  SprinklerNode node(FLAGS_id, FLAGS_port, role,
      ...
      FLAGS_gc_disk_thread_count, FLAGS_fragments);
